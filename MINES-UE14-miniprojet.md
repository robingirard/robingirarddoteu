 ...
 *	le poster doit être réalisé à partir de [ce patron]({{site.url}}/UE14-2023-Sujet-XX.pptx). A partir de 2024 vous ne devez plus imprimer le poster, seul les 5 meilleurs posters seront imprimés après les soutenances et exposés à l'école des mines. Faites parvenir par mail à Robin Girard (avant la soutenance) le fichier poster pptx et le document word contenant la note A4 recto-verso  en remplaçant XX par votre numéro de sujet et en mettant votre tuteur en copie ; l’objet du mail doit être [UE14-miniprojet]. Ces documents seront partagés sur ce site. 
